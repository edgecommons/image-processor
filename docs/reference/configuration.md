...
| Key | Type | Default | Meaning |
|---|---|---|---|
| `devices` | string[] | `["0"]` | The devices the component may place sessions on, as CUDA ordinals (`"0"`) or device UUIDs. The component starts one executor cell per listed device. |
